...
function customDatepicker($) {
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
            '<tr>' +
            '<th class="prev"><i class="fa fa-chevron-left fi-arrow-left el-icon-arrow-left"/></th>' +
            '<th colspan="5" class="date-switch"></th>' +
            '<th class="next"><i class="fa fa-chevron-right fi-arrow-right el-icon-arrow-right "/></th>' +
            '</tr>' +
            '</thead>',
